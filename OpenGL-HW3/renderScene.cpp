...
// Добавлены по два точечных и источника света и прожектора.
// Солнце реализовано с помощью вращающегося источника параллельного света(день/ночь)
// Ночью включаются прожекторы, днем выключаются
// Прожектор вращается по кругу освещая область вокруг
// Источники точечного света обозначены сферами
// Прозрачность кубов изменяется от 0 до 1 по кругу
// Q - toggle Sun
// E - toggle Spotlight
